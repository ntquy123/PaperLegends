...
public class PaperLegendCharacterNetworkHandler : NetworkBehaviour
{
    ...
    private bool HandleLanding()
    {
        ...
        if (TryApplyHero10000001EdgeBounceOnLanding())
        {
            _hadAirbornePhase = true;
            State = PaperLegendCharacterState.Flicked;
            return true;
    ...
    private bool TryApplyHero10000001EdgeBounceOnLanding()
    {
        ...
        Debug.Log($"[PaperLegends][Skill] player={PlayerId} edge bounce rebound: direction={direction}, remaining={_remainingHero10000001EdgeBounces}, impulse={impulse}.");
        return true;
    }
    ...
    {
        ServerDispatchDirectionalSkillEvent(
            PaperLegendHeroSkillId.Hero10000001EdgeBounceRebound,
            4,
            worldPosition,
            edgeBounceVfxRadius,
            direction);
