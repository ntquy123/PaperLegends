// Assets/Script/GamePlay/Culi/BallSkill_99000006.cs
using UnityEngine;

/// <summary>
/// Giảm một nửa kích thước (scale) của viên bi trong một số lượt.
/// Có số lần sử dụng giới hạn.
/// </summary>
public class BallSkill_99000006 : MonoBehaviour, IFBall
{
    public int level;
    public GameObject shrinkVFX; // Hiệu ứng khi bi thu nhỏ
